        ...
        <div className="hidden md:flex w-1/2 bg-[#050505] relative flex-col justify-between p-12 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-2 mb-8">
               ...
               <span className="text-2xl font-bold text-white tracking-wide">File<span className="text-brand">Vault</span></span>
            </div>
          ...
          <div className="relative z-10 mt-12 flex justify-center items-center">
             ...
             <div className="relative w-64 h-64">
                ...
                <div className="absolute top-4 left-4 w-48 h-56 bg-brand rounded-2xl shadow-2xl shadow-brand/20 transform -rotate-6 z-20 flex flex-col items-center justify-center p-6 border border-white/20">
